...
public class NewEntryDialog extends JDialog {
	...
	public NewEntryDialog(JFrame parent, BookTableModel tableModel) throws ClassNotFoundException {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tfId.getText().isEmpty() || tfAuthor.getText().isEmpty() || tfTitle.getText().isEmpty()
						|| datePicker.getModel().getValue() == null || cbStatus.getSelectedItem().equals("")) {
					...
					Book konyv = new Book(Integer.parseInt(tfId.getText()), tfAuthor.getText(), tfTitle.getText(),
							(Date) datePicker.getModel().getValue(), cbStatus.getSelectedItem().toString());
					tableModel.add(konyv);
